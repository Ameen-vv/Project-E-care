...
export const editProfile = (req, res) => {
    try {
        ...
        doctorModel
            .updateOne({ _id: req.doctorLogged }, {
                $set: details
            })
            .then((update) => {
...
export const timeSlots = (req, res) => {
    try {
        ...
        checkSlots(slots, req.doctorLogged)
            .then((check) => {
                if (!check) {
                    doctorModel
                        .updateOne({ _id: req.doctorLogged }, {
...
export const appointmentVisited = (req, res) => {
    try {
        appointmentModel
            .updateOne({ _id: req.query.appointmentId }, {
                $set: {
                    status: 'visited'
                }
            })
        ...
        appointmentModel
            ...
            .then((appointment) => {
                ...
                transaction
                    ...
                    .then((transaction) => {
                        walletModel
                            .updateOne({ userId: appointment.patientId }, {
                                $inc: {
                    ...
                    .then((appointments) => {
                        ...
                        appointmentModel
                            ...
                            .then((count) => {
                                ...
                                getAppointmentCountDoctor(req.doctorLogged)
                                    .then((count) => {
